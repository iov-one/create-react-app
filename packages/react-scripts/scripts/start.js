...
checkBrowsers(paths.appPath, isInteractive)
  // chrome-extension-react-scripts START
  .then(() => fsExtra.emptyDir(paths.appBuild))
  ...
  .then(port => {
    ...
    // chrome-extension-react-scripts START
    const writeToDiskConfig = { ...serverConfig, writeToDisk: true };
    const devServer = new WebpackDevServer(compiler, writeToDiskConfig);
    // chrome-extension-react-scripts END
...
function copyPublicFolder() {
  return fsExtra.copy(paths.appPublic, paths.appBuild, {
    dereference: true,
